...
sender_password = "your_app_password"     # Replace with your email password or app-specific password
receiver_email = "recipient@gmail.com"  # Replace with the recipient's email
...
<body>
   <div class="container">
       ...
       <p style="font-size: 16px; color: #333;">file:///Users/p5ina/projects/auca/information-security/lab4/index.html#</p>
